...
class Menu:
    def __init__(self):
        ...
        self.new_game_txt = "Nueva Partida"
        self.load_game_txt = "Continuar"
        self.quit_game_txt = "Salir"
...
def main():
    ...
    numero = input('Ingrese el número del mapa: ')
    ...
    while run:
        ...
        sokoban = Game(window, numero)
        sokoban.start(numero)
